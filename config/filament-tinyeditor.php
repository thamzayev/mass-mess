...
return [
    'version' => [
        ...
        'licence_key' => env('TINY_LICENSE_KEY', 'gpl'),
    ],
    ...
    'extra' => [
        'toolbar' => [
            ...
            'fontfamily' => 'DejaVu Sans=DejaVu Sans, sans-serif; Times New Roman=Times New Roman, Times, serif; Arial=arial,helvetica,sans-serif; Courier New=courier new,courier; Georgia=georgia,palatino; Helvetica=helvetica,sans-serif; Verdana=verdana,geneva;',
        ]
    ]
];
